...
# pip install python-docx - для загрузки: перенести фразу в терминал
# pip list - для проверки установленных библиотек
# pip uninstall python-docx - удаление библиотеки
